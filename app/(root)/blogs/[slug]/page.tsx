...
import { getDetailBlogs } from "@/service/blogs";
import { getTimeReading } from "@/lib/utils";
import { format } from "date-fns";

const SlugPage = async ({params}: {params: {slug: string}}) => {
	
	const blog = await getDetailBlogs(params.slug)	
    ...
    return (
        <div className="pt-[15vh] max-w-5xl mx-auto px-3 md:px-1">
			...
			/>
            <div className="flex md:gap-12 max-md:flex-col-reverse mt-12 ">
				<div className="flex flex-col space-y-8">
					<div className="sticky top-45">
						<h2 className="text-lg uppercase text-muted-foreground">Share</h2>
